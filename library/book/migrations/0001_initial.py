    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('russian', 'Russian'), ('english', 'English'), ('unknown', '---')], default='unknown', max_length=32, verbose_name='language')),
                ...
                ('checksum', models.CharField(blank=True, max_length=64, unique=True, verbose_name='checksum')),
